                    ...
                    <div class="flex items-center h-12 md:h-20 xl:h-24">
                        ...
                        <div class="flex-grow hidden md:block">
                            <nav class="flex justify-center text-base font-bold cha-nav-link text-gray-400">
                                <g-link
                                    class="px-4 py-4 md:mr-3 xl:mr-10 hover:text-black group transition-all duration-200 ease-in-out flex items-center"
                                    to="/about/">
                                    <div class="relative">
                                        O nás
                                        <div
                                            class="absolute inset-x-0 mt-1 h-1 rounded opacity-0 bg-gradient-r-blue-green group-hover:opacity-100"></div>
                                    </div>
                                </g-link>
                                <g-link
                                    class="px-4 py-4 md:mr-3 xl:mr-10 hover:text-black group transition-all duration-200 ease-in-out flex items-center"
                        ...
                        <div class="w-15/24 md:w-3/24 xl:w-2/24">
                            <div class="flex items-center justify-end">
                                <g-link
                                    class="inline-flex justify-center px-4 py-1 text-sm font-semibold text-green-500 border border-gray-100 rounded-full min-w-40 md:py-3 md:border-none md:text-base md:text-white hover:shadow-lg transition-all duration-200 ease-in-out md:bg-gradient-r-blue-green active"
                                    to="/contact/">Kontakt
                                </g-link>
