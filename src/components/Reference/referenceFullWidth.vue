    ...
    >
        ...
        <div
            ...
            <div
                ...
                <g-link
                    :to="props.baseUrl"
                    class="relative block transition-transform duration-200 ease-in-out transform aspect-ratio-square xl:translate-x-8 group-hover:translate-x-0"
                >
                    <g-image
            ...
            <div class="col-start-6 col-end-11 row-start-1 row-end-1 pointer-events-auto md:col-start-10 md:col-end-13"
                 v-if="props.reference.referenceMultipleImages.length === 2">
                <g-link
                    :to="props.baseUrl"
                    class="relative block transition-transform duration-200 ease-in-out transform aspect-ratio-square xl:group-hover:translate-x-8"
                >
                    <g-image
                        class="absolute inset-0 object-cover w-full h-full"
