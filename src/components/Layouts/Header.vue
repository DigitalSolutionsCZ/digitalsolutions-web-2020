<template>
    <header
        class="fixed inset-x-0 top-0 shadow-lg mobileLandscape:shadow-none"
    ...
    >
        <div class="relative">
            <div class="flex justify-between mx-auto max-w-screen-3xl h-13 mobileLandscape:h-19">
                ...
                <div
                    class="absolute inset-x-0 z-20 items-center justify-center flex-grow xs:left-auto xs:w-full top-full mobileLandscape:flex mobileLandscape:relative mobileLandscape:top-auto xs:max-w-xs mobileLandscape:visible mobileLandscape:max-w-none mobileLandscape:items-stretch"
                ...
                >
                    ...
                    >
                        <template v-for="menuItem in menu">
                            <g-link
                                :key="menuItem.id"
                                class="relative flex p-4 text-xs transition-all duration-200 ease-in-out mobileLandscape:py-0 mobileLandscape:mr-3 xl:mr-10 group lg:text-base focus:outline-none"
                                :class="[white ? 'cha-nav-link mobileLandscape:cha-nav-link-color' : 'hover:text-gray-900', {'text-gray-900': activeMenu(menuItem)}]"
                ...
                <div class="flex items-center mobileLandscape:pr-3">
                    <div class="flex items-center justify-end">
                        <g-link
                            class="inline-flex justify-center px-4 py-2 text-xs font-semibold leading-tight transition-all duration-200 ease-in-out rounded-full mobileLandscape:px-5 mobileLandscape:py-3 mobileLandscape:text-sm"
                        ...
                        <div class="relative z-50 inline-block p-3 mx-2 cursor-pointer mobileLandscape:hidden focus:outline-none" @click.prevent="toggle" tabindex="1" data-toggle-menu>
                            <div class="w-5 h-4 hamburger" :class="{'is-active': open}">
                                <div
                                    class="bg-gray-600 hamburger-inner h-2px"
                                    :class="{'ls:bg-white': white}"
                                />
                            </div>
                        </div>
                    </div>
