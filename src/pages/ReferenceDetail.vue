<template>
    <Layout>
        <div class="ml-auto mr-auto max-w-screen-2xl">
            <section class="flex flex-wrap pt-16 pb-20">
        ...
        <div class="py-8">
            <div class="ml-auto mr-auto max-w-screen-2xl">
                <section class="flex flex-wrap">
                    <div class="self-center w-full px-4 lg:w-1/2 lg:pr-12">
                        <h2 class="mb-8 text-2xl font-bold">Výzva</h2>
                        <div class="text-base wysiwyg-content">
                            <p>
                    ...
                    <div class="self-start w-full px-4 lg:w-1/2 group">
                        <!--TODO Create component-->
                        <div class="bg-green-200 rounded group-hover:shadow-xl">
                            <div class="pt-16 mx-16">
                                <img src="https://www.mmreality.cz/data/imgs/logo.png" alt="logo partnera" class="mb-8">
                            ...
                            <a href="#nogo" class="inline-flex items-center py-2 pl-16 mb-16 text-xs font-bold bg-gray-300 rounded-r-full group-hover:text-white group-hover:bg-gradient-r-blue-green">
                                Co k zakázce řekl klient?
                                <span class="px-4">chevron-right</span>
                            </a>
                        </div>
        ...
        <div class="ml-auto mr-auto max-w-screen-2xl">
            <section class="flex flex-wrap pb-16">
                <div class="relative w-full px-4 lg:w-1/2 lg:pr-12">
                    <h2 class="mb-8 text-2xl font-bold">Výsledek</h2>
                    <div class="mb-6 text-base wysiwyg-content">
                    ...
                    <div class="absolute inset-y-0 right-0 w-1 h-full rounded bg-gradient-t-blue-green"></div>
                </div>
                <div class="w-full px-4 lg:w-1/2 lg:pl-12">
                    <h2 class="mb-8 text-2xl font-bold text-green-500">Výsledek</h2>
