                ...
                <section class="flex flex-wrap">
                    ...
                    <div class="self-start w-full px-4 lg:w-10/24 group">
                        ...
                        <div class="bg-white rounded group-hover:shadow-xl">
                            ...
                            <a href="#client-survey" class="inline-flex items-center py-2 pl-16 mb-16 text-xs font-bold bg-gray-300 rounded-r-full group-hover:text-white group-hover:bg-gradient-r-blue-green">
                ...
                <div class="w-full px-4 lg:w-1/2 lg:pl-16" id="client-survey">
                    <div class="lg:w-18/24">
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                <strong class="text-lg">Zdeněk samek</strong>
                                <div class="text-base">regionální ředitel pro Prahu a , M&M reality</div>
                            </div>
                        </div>
                    </div>
                </div>
