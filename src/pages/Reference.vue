        ...
        <section class="px-4 bg-white">
            <div class="pt-10 mx-auto max-w-screen-xl">
                ...
                <div class="mb-10 text-center">
                    <a href="" class="inline-block px-8 py-2 border-gray-100 rounded-full border-3 focus:outline-none">
                        Všechny projekty
                    </a>
                </div>
            </div>
        ...
        <section class="px-4 pt-4 pb-8 bg-gray-100">
            <div class="relative mx-auto max-w-screen-xl">
                ...
                <div class="flex justify-center">
                    <g-link class="flex text-base font-semibold items-center justify-center px-8 py-3 mx-2 text-gray-800 bg-white rounded-full hover:shadow-lg transition-all duration-200 ease-in-out" to="/">Předchozí</g-link>
                    <g-link class="flex text-base font-semibold items-center justify-center px-8 py-3 mx-2 text-white rounded-full hover:shadow-lg transition-all duration-200 ease-in-out bg-gradient-r-blue-green" to="/">Načíst 10 dalších...</g-link>
                    <g-link class="flex text-base font-semibold items-center justify-center px-8 py-3 mx-2 text-gray-800 bg-white rounded-full hover:shadow-lg transition-all duration-200 ease-in-out" to="/">Další</g-link>
                </div>
            </div>
        </section>
    </Layout>
